# -*- coding: utf-8 -*-
"""
Created on Wed Apr  1 07:53:25 2020
...
data_check= []
pagelink = "https://www.worldometers.info//coronavirus//"
...
while True:
    try:
        html_page = requests.get(pagelink)
    ...
    message = "Total infected = {}, New Case = {}, Total Deaths = {}, New Deaths = {}, Recove= {}, Active Case = {}, Serious Critical = {}".format(*data)
